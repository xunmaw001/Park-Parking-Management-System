            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">车主管理</li>
                        <li class="breadcrumb-item active">车主列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">车主列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                 
                                        <label>
                                            姓名
                                            <input type="text" id="chezhuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="姓名" aria-controls="tableId">
                                        </label>
                                                                 
                                        <label>
                                            身份证号
                                            <input type="text" id="chezhuIdNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="身份证号" aria-controls="tableId">
                                        </label>
                                 
                                        <label>
                                            手机号
                                            <input type="text" id="chezhuPhoneSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="手机号" aria-controls="tableId">
                                        </label>
                                 
                                        <label>
                                            车牌号
                                            <input type="text" id="chezhuChepaiNumberSearch" style="width: 140px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //车牌号
        var chezhuChepaiNumberCell = document.createElement('td');
        chezhuChepaiNumberCell.innerHTML = item.chezhuChepaiNumber;
        row.appendChild(chezhuChepaiNumberCell);

            //照片
        var chezhuPhotoCell = document.createElement('td');
        var chezhuPhotoImg = document.createElement('img');
        var chezhuPhotoImgValue = item.chezhuPhoto;
        if(chezhuPhotoImgValue !=null && chezhuPhotoImgValue !='' && chezhuPhotoImgValue !='null'){
            chezhuPhotoImg.setAttribute('src', chezhuPhotoImgValue);
            chezhuPhotoImg.setAttribute('height', 100);
            chezhuPhotoImg.setAttribute('width', 100);
            chezhuPhotoCell.appendChild(chezhuPhotoImg);
        }else{
            chezhuPhotoCell.innerHTML = "暂无图片";
        }
        row.appendChild(chezhuPhotoCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("chezhu/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addchezhu", "addchezhu");
        window.location.href = "add-or-update.jsp"
    }
