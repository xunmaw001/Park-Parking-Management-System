                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chezhuName" name="chezhuName" class="form-control"
                                                   v-model="ruleForm.chezhuName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chezhuIdNumber" name="chezhuIdNumber" class="form-control"
                                                   v-model="ruleForm.chezhuIdNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chezhuPhone" name="chezhuPhone" class="form-control"
                                                   v-model="ruleForm.chezhuPhone" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chezhuChepaiNumber" name="chezhuChepaiNumber" class="form-control"
                                                   v-model="ruleForm.chezhuChepaiNumber" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>照片</label>
                                        <img id="chezhuPhotoImg" width="100" height="100">
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="chezhuId" name="chezhuId" v-model="ruleForm.chezhuId" readonly type="hidden">
